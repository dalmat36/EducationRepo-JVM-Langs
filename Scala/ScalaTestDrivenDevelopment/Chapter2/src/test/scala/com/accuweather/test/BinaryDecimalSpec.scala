...
import com.packt.BaseConversion
import org.scalatest.FlatSpec

class BinaryDecimalSpec extends FlatSpec {
  ...
  it should "convert binary number 11110001111110111 to decimal equivalent 123895" in {
    var decimal: Decimal =
      BaseConversion.binaryToDecimal(Binary("11110001111110111"))
    assert(decimal.number == "123895")
  }

  it should "convert binary number 100000000000001110000001 to decimal equivalent 8389505" in {
    var decimal: Decimal =
      BaseConversion.binaryToDecimal(Binary("100000000000001110000001"))
